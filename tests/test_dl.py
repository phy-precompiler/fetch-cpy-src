...
# local imports
from fetch_cpy_src.downloader import get_cpython_repo, download_cpython_file, download_cpython_dir
...
def test_dl_file():
    ...
    repo = get_cpython_repo(access_token=access_token)
    ...
    for test_path in test_path_list:
        download_cpython_file(repo, test_path, '3.12', TMP_DIR)
...
def test_dl_dir():
    ...
    for test_path in test_path_list:
        download_cpython_dir(repo, test_path, '3.12', TMP_DIR)
